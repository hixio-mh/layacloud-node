...
GameMgr.prototype.init = async function() {
  ...
  // FIXME: 删除
  let gameId = "cloud_8042"
  let loader = new cp.CodeLoader()
  let code = await loader.load(gameId);
  console.log(">>>>>>>>mgr init code is ", code); // Object
...
GameMgr.prototype.loadGame = async function(gameId) {
  try {
    ...
    console.log("code is ", code); // Object
