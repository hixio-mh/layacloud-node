...
function Room(mgr, roomId, ownerId, roomName, isSupervisor) {
  ...
  this._syncEventPool = new SyncEventPool(roomId)

  // 房间对应的engine
  this._engine = new Engine(this._game, this, roomName)
}
...
Room.prototype.syncEventToSup = function(type, data) {
  this._syncEventPool.add(type, data)
}
