...
SupervisorHelper.syncSysEvent = async function (userId, type, data) {
  ...
  return await SupvervisorHelper._doSyncEvent(supNodeList, "sync_sys_event", roomId, [type, data])
}
 ...
 * @param {*} list
 */
SupvervisorHelper._doSyncEvent = async function(supNodeList, type, roomId, list) {
