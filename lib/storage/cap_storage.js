...
Storage.prototype.enroll = function (node) {
    ...
    node.handleMessage('message_perm_provision', this.handleMessagePermProvision);

    node.handleMessage('message_data_verified', this.handleMessageDataVerified);
...
Storage.prototype.handleMessagePermProvision = function (message) {
...
Storage.prototype.handleMessageDataVerified = function(message) {
